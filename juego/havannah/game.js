...
export const game = {
  meta: {
    ...
    help:
      ...
      'Carlo); «💡 Pista» y «⚖️ ¿Quién gana?» son estimaciones, no veredictos exactos. En tableros más anchos (<b>base 8</b>) ' +
      'la máquina dispone de <b>menos análisis por jugada</b>, así que juega más floja; en el tamaño <b>normal (base 6)</b> es ' +
      'donde da su mejor nivel —si buscas reto, quédate en base 6.</p>',
